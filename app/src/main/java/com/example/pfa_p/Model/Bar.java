...
public class Bar {
    ...
    private void createBar(Context context) {
      ...
      //  description.setBackgroundColor(Color.YELLOW);
        ...
        valuePercentage = valueWeight*100;
        String valueString = String.format(java.util.Locale.US,"%.2f", valuePercentage) + "%";
        valueSpace.setText(valueString);
        valueSpace.setGravity(Gravity.END);
        valueSpace.setTextColor(Color.WHITE);
        ...
        emptySpace.setBackgroundColor(Color.GRAY);
